...
// Affine matrix
#define MAT_EYE					imat3(1,0,0, 0,1,0, 0,0,1)						// eye matrix
...
#define MAT_rot_clw(a)			mat3(cos(a),sin(a),1, cos(a),-sin(a),1, 0,0,1)	// rotating matrix clockwise (↻)
#define MAT_rot_ctclw(a) 		mat3(cos(a),-sin(a),1, cos(a),sin(a),1, 0,0,1)	// rotating matrix counterclockwise (↺)
#define MAT_T(m)				imat3(m[0][0],m[1][0],m[2][0], m[0][1],m[1][1],m[2][1], m[0][2],m[1][2],m[2][2]);	// transpose matrix
